...
//Connection DB
mongoose.connect(varenv.mongo_url) //Nueva variable de env
...
app.use(session({
    ...
    store: MongoStore.create({
        mongoUrl: varenv.mongo_url, //Nueva variable de env
        ttl: 60 * 60
    }),
    saveUninitialized: true //Fuerzo a que la sesion se guarde en lo que seria el storage
}))
app.use(cookieParser(varenv.cookies_secret))//Firma de cookie "secretKey"
